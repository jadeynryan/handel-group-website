...
[Designing better influenza vaccines]{.card-title}

![](images/projects/influenza-vaccines.png){.card-image-right}
...
[Model-guided vaccines for norovirus]{.card-title}

![](images/projects/norovirus-vaccines.png){.card-image-left}
...
::: {.card}
[Modeling and analysis of influenza immune responses]{.card-title}

![](images/projects/influenza-immunity.png){.card-image-right}
